...
- The current baseline after post-foundation cycle 8 is `215 passed` from `python -m pytest -q`.
...
Current checkpoint: [docs/releases/checkpoint-post-foundation-cycle-8.md](docs/releases/checkpoint-post-foundation-cycle-8.md)
