...
- The current baseline after post-foundation cycle 9 is `250 passed` from `python -m pytest -q`.
...
- Post-foundation cycle 8: [docs/releases/checkpoint-post-foundation-cycle-8.md](docs/releases/checkpoint-post-foundation-cycle-8.md)
- Post-foundation cycle 9: [docs/releases/checkpoint-post-foundation-cycle-9.md](docs/releases/checkpoint-post-foundation-cycle-9.md)

Current checkpoint: [docs/releases/checkpoint-post-foundation-cycle-9.md](docs/releases/checkpoint-post-foundation-cycle-9.md)
