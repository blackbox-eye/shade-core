...
- The stable public package surface is the root `shade_core` import surface.
- Internal modules under `src/shade_core/` implement that surface and are not separately described here as stable package entrypoints.
