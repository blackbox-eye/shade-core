...
- The worker, worker-orchestration, checkpoint, verification, evidence, audit, lineage, and publication objects currently exist as contract-prep boundaries only.
